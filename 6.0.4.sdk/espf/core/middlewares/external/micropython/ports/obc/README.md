...
This port is based on the minimal MicroPython port.
It is specific port to be included in the Endurosat OBC module..
...
This OBC port can be built with the built-in MicroPython compiler
