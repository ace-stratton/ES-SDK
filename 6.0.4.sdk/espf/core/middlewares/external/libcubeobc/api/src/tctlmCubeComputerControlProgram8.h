...
/**
 * @brief Enumeration for TctlmCubeComputerControlProgram8_StrInstanceSelect
*/
typedef enum TctlmCubeComputerControlProgram8_StrInstanceSelectEnum {
    TCTLM_CUBE_COMPUTER_CONTROL_PROGRAM_8__STR_0 = 0,    /**< Str0 */
    TCTLM_CUBE_COMPUTER_CONTROL_PROGRAM_8__STR_1 = 1,    /**< Str1 */
} TctlmCubeComputerControlProgram8_StrInstanceSelect;

/**
 * @brief Enumeration for TctlmCubeComputerControlProgram8_FssInstanceSelect
*/
typedef enum TctlmCubeComputerControlProgram8_FssInstanceSelectEnum {
    TCTLM_CUBE_COMPUTER_CONTROL_PROGRAM_8__FSS_0 = 0,    /**< Fss0 */
    TCTLM_CUBE_COMPUTER_CONTROL_PROGRAM_8__FSS_1 = 1,    /**< Fss1 */
    TCTLM_CUBE_COMPUTER_CONTROL_PROGRAM_8__FSS_2 = 2,    /**< Fss2 */
    TCTLM_CUBE_COMPUTER_CONTROL_PROGRAM_8__FSS_3 = 3,    /**< Fss3 */
} TctlmCubeComputerControlProgram8_FssInstanceSelect;
...
typedef enum TctlmCubeComputerControlProgram8_Pst3sOperatingModesEnum {
    TCTLM_CUBE_COMPUTER_CONTROL_PROGRAM_8__NORMAL_MODE = 0,        /**< Normal Mode */
    TCTLM_CUBE_COMPUTER_CONTROL_PROGRAM_8__FIXED_THRESHOLD = 1,    /**< Fixed Threshold */
    TCTLM_CUBE_COMPUTER_CONTROL_PROGRAM_8__SELF_TEST = 2,          /**< Self-Test Mode */
...
typedef struct TCTLM_PACKED TctlmCubeComputerControlProgram8_ConfigAdcsControllerStruct {
    ...
    F32 wy_ref;                                                       /**< Reference spin rate (wy-ref). Must always be smaller than 0  (measurment unit is [degps]. valid range is between -5 degps and 0 degps) */
...
typedef struct TCTLM_PACKED TctlmCubeComputerControlProgram8_ConfigActuatorMtqStruct {
    F32 mtq0Mmax;     /**< MTQ0 maximum dipole moment  (measurment unit is [A.m^2]. valid range is between 0 A.m^2 and 10 A.m^2) */
    F32 mtq1Mmax;     /**< MTQ1 maximum dipole moment  (measurment unit is [A.m^2]. valid range is between 0 A.m^2 and 10 A.m^2) */
    F32 mtq2Mmax;     /**< MTQ2 maximum dipole moment  (measurment unit is [A.m^2]. valid range is between 0 A.m^2 and 10 A.m^2) */
...
typedef struct TCTLM_PACKED TctlmCubeComputerControlProgram8_TlmStrPst3sRawStruct {
    U32 timeSeconds;                                                                               /**< Unix time integer seconds  (measurment unit is [s]) */
    U32 timeNs;                                                                                    /**< Unix time fraction nanoseconds  (measurment unit is [ns]) */
    TctlmCubeComputerControlProgram8_StrInstanceSelect strInstance;                                /**< Star tracker TCTLM instance  */
    TctlmCubeComputerControlProgram8_Pst3sVersion pst3sVersion;                                    /**< PST3S Version  */
    ...
    TctlmCubeComputerControlProgram8_Pst3sRateQuality rateQuality;                                 /**< PST3S Rate Quality  */
    ...
    TctlmCubeComputerControlProgram8_Pst3sSelfTestResult cmosChipIdResult;                         /**< PST3S CMOS Chip ID Self-test Result  */
    TctlmCubeComputerControlProgram8_Pst3sSelfTestResult fpgaMRamResult;                           /**< PST3S FPGA MRAM Self-test Result  */
    U8 numberOfExtractedStars;                                                                     /**< PST3S Number of Extracted Stars  */
    TctlmCubeComputerControlProgram8_Pst3sOperatingModes operatingMode;                            /**< PST3S Operating Mode  */
    U8 imagingGain;                                                                                /**< PST3S Imaging Gain  */
    U8 minNavigationStars;                                                                         /**< PST3S Minimum Navigation Stars When Quaternion is Valid  */
    TctlmCubeComputerControlProgram8_Pst3sDataValid dataValid;                                     /**< PST3S Data Valid  */
    TctlmCubeComputerControlProgram8_Pst3sExtImageState extImageState;                             /**< PST3S External Image State  */
    ...
    TctlmCubeComputerControlProgram8_Pst3sDynamicMode dynamicMode;                                 /**< PST3S Dynamic Mode  */
    TctlmCubeComputerControlProgram8_Pst3sSaaWorkingMode saaMode;                                  /**< PST3S SAA Mode  */
    U8 saaThreshold;                                                                               /**< PST3S SAA Threshold  */
    TctlmCubeComputerControlProgram8_Pst3sQuaternionFilteringGetState quaternionFilteringState;    /**< PST3S Quaternion Filtering State  */
...
typedef struct TCTLM_PACKED TctlmCubeComputerControlProgram8_TlmHssCubeSenseEarthHealthStruct {
    ...
    F64 hss0DetectorTemp;       /**< HSS0 Detector Temperature  (measurment unit is [K]) */
    ...
    F64 hss1DetectorTemp;       /**< HSS1 Detector Temperature  (measurment unit is [K]) */
...
typedef struct TCTLM_PACKED TctlmCubeComputerControlProgram8_TlmStrHealthStruct {
    ...
    Boolean str0Overcurrent;    /**< STR0 CAM overcurrent  */
    U32 str0ErrorCode;          /**< STR0 Error Code  */
    F64 str1McuTemp;            /**< STR1 MCU Temperature  (measurment unit is [°C]) */
    F64 str1McuCurrent;         /**< STR1 MCU current  (measurment unit is [mA]) */
    U16 str1McuVoltage;         /**< STR1 MCU supply voltage  (measurment unit is [mV]. valid range is between 0 mV and 5000 mV) */
    F64 str1Current;            /**< STR1 current  (measurment unit is [mA]) */
    Boolean str1Overcurrent;    /**< STR1 CAM overcurrent  */
...
/**
 * @brief ID 53, Sun Sensor TCTLM instance
 * @details Sun Sensor instance used for TCTLM
 *
 * @param[in] endpoint Node endpoint location
 * @param[in] setVal Value Written
 *
...
/**
 * @brief ID 75, Star tracker TCTLM instance
 * @details Star tracker instance used for TCTLM
 *
 * @param[in] endpoint Node endpoint location
 * @param[in] setVal Value Written
 *
