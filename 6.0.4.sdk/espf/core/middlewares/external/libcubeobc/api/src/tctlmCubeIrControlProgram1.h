...
typedef struct TCTLM_PACKED TctlmCubeIrControlProgram1_ConfigurationStruct {
    ...
    U16 maxSpaceTemp;                /**< Hard threshold in dK.  */
    U8 horizonCrossOverOffset;       /**< The offset from the max space temperature  */
    U16 minimumGradient;             /**< Minimum fradient to be considered a horizon  */
    U8 minimumEdgePointsRequried;    /**< The minimum amount of edge points required to do a polynomial fitting  */
