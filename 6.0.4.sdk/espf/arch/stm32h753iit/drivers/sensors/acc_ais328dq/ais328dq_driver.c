 ...
 */
/**
 * @addtogroup acc_ais328dq AIS328DQ
 * @{
 *
 * @file     ais328dq_driver.c
 * @brief    Accelerometer AIS328DQ driver implementation
 *
 * @}
 *
 */
...
#else
    if (HAL_OK != HAL_I2C_Mem_Read(&SENSORS_I2C_HANDLER, deviceAddr, Reg, 1, Data, 1, 10))
      return SEN_ERROR;
#endif
...
* Return		: Status [SEN_ERROR, SEN_SUCCESS]
*******************************************************************************/
status_t AIS328DQ_WriteReg(uint8_t deviceAddress, uint8_t WriteAddr, uint8_t Data)
{
    HAL_StatusTypeDef I2C_retStat;
#if 1
    I2C_retStat = MX_I2C_Take(MX_I2C_BUS_SYSTEM,50);
    ...
    if (HAL_OK != HAL_I2C_Mem_Write(&SENSORS_I2C_HANDLER, deviceAddress, WriteAddr, 1, &Data, 1, 10))
      return SEN_ERROR;
#endif
