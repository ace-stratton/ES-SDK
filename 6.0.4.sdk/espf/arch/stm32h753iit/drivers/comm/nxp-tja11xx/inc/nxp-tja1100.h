...
#define IS_ERROR(err) (err < PHY_STATUS_OK)

#define  PHY_STATUS_READ_ERROR            ((int32_t)-5)
#define  PHY_STATUS_WRITE_ERROR           ((int32_t)-4)
#define  PHY_STATUS_ADDRESS_ERROR         ((int32_t)-3)
#define  PHY_STATUS_RESET_TIMEOUT         ((int32_t)-2)
#define  PHY_STATUS_ERROR                 ((int32_t)-1)
#define  PHY_STATUS_OK                    ((int32_t) 0)
...
#define TJA1100_EXTENDED_CTRL_POWER_MODE_MASK         0x7800
...
#define TJA1100_EXTENDED_CTRL_TEST_MODE_MASK          0x01C0
...
#define TJA1100_EXTENDED_CTRL_LOOPBACK_MODE_MASK      0x0018
...
#define TJA1100_CONFIG1_TX_AMPLITUDE_MASK             0x0C00
...
#define TJA1100_CONFIG1_MII_MODE_MASK                 0x0300
...
#define TJA1100_SW_RESET_TO    ((uint32_t)500U)
#define TJA1100_INIT_TO        ((uint32_t)2000U)


typedef int32_t (*tja1100_Init_Func)(void);
typedef int32_t (*tja1100_DeInit_Func)(void);
typedef int32_t (*tja1100_ReadReg_Func)(uint32_t, uint32_t, uint32_t*);
typedef int32_t (*tja1100_WriteReg_Func)(uint32_t, uint32_t, uint32_t);
typedef int32_t (*tja1100_GetTick_Func)(void);

typedef struct
{
    tja1100_Init_Func Init;
    tja1100_DeInit_Func DeInit;
    tja1100_WriteReg_Func WriteReg;
    tja1100_ReadReg_Func ReadReg;
    tja1100_GetTick_Func GetTick;
} tja1100_IOCtx_t;
...
int32_t TJA1100_DisablePowerDownMode(phy_Object_t *pObj);
int32_t TJA1100_EnablePowerDownMode(phy_Object_t *pObj);
int32_t TJA1100_StartAutoNego(phy_Object_t *pObj);
int32_t TJA1100_GetLinkState(phy_Object_t *pObj);
int32_t TJA1100_SetLinkState(phy_Object_t *pObj, uint32_t LinkState);
int32_t TJA1100_EnableLoopbackMode(phy_Object_t *pObj);
int32_t TJA1100_DisableLoopbackMode(phy_Object_t *pObj);
int32_t TJA1100_EnableIT(phy_Object_t *pObj, uint32_t Interrupt);
int32_t TJA1100_DisableIT(phy_Object_t *pObj, uint32_t Interrupt);
int32_t TJA1100_ClearIT(phy_Object_t *pObj, uint32_t Interrupt);
int32_t TJA1100_GetITStatus(phy_Object_t *pObj, uint32_t Interrupt);
